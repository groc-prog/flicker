...
CREATE TYPE "bot_tone" AS ENUM('normal', 'lewd', 'super_hyped');--> statement-breakpoint
...
CREATE INDEX "idx_movie_language_title" ON "movies" USING gin ("language", "title" gin_trgm_ops);--> statement-breakpoint
